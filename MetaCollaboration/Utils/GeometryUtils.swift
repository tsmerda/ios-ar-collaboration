...
//  MetaCollaboration
//
//  Created by Tomáš Šmerda on 17.05.2023.
//
...
class GeometryUtils {
    ...
    static func createRectLayerWithBounds(_ bounds: CGRect, color: CGColor, borderColor: CGColor) -> CALayer {
    ...
    static func createLayer(forRecognizedObjects objects: [RecognizedObject],
        ...
        let color = CGColor(red: 1.0, green: 1.0, blue: 0.2, alpha: 0.3)
        ...
        for object in objects {
            ...
            let layer = GeometryUtils.createRectLayerWithBounds(rect, color: color, borderColor: borderColor)
